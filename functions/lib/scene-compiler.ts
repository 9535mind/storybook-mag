...
const SETTING_LEX: Array<{ re: RegExp; en: string }> = [
  ...
  { re: /여자\s*대학|여대|women'?s\s*university|women'?s\s*college/i, en: 'women\'s university student context' },
  { re: /대학|대학교|university|college/i, en: 'university student context' },
